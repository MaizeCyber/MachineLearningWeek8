...
def makelog():
    X_train, X_test, y_train, y_test, class_names, feature_names = preprocessScale('Obfuscated-MalMem2022.csv', "Class", 0.10,
                                                                           "Category")
...
def make_svm():
    X_train, X_test, y_train, y_test, class_names, feature_names = preprocessScale('Obfuscated-MalMem2022.csv',
                                                                                   "Class", 0.01,
                                                                                   "Category")
